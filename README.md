...
1. How would you describe acessibility on the web to someone new to programming?
    Readable code that is compatible with different screens but also for screen readers

2. Talk about 3 different things you can do to ensure your website is accessible.
    Comment well and frequently
    Make sure everything scales corectly
    add alt tags for screen readers 
